...
def draw_window(right, left, right_bullets, left_bullets, right_health, left_health, start, left_hits, right_hits):
    WIN.blit(SPACE, (0, 0))
...
def main(left_points, right_points):
    ...
    while run:
        ...
        start, right_hits, left_hits = draw_window(right, left, right_bullets, left_bullets,
                            right_health, left_health, start, left_hits, right_hits)
